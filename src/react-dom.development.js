  ...
  (function () {
    ...
    function trapEventForResponderEventSystem(
      ...
      if (enableEventAPI) {
        ...
        var listener = dispatch.bind(null, topLevelType, eventFlags);
    ...
    function listenToEventResponderEvents(eventResponder, element) {
      if (enableEventAPI) {
        var targetEventTypes = eventResponder.targetEventTypes;
        ...
        for (var i = 0, length = targetEventTypes.length; i < length; ++i) {
          var targetEventType = targetEventTypes[i];
          ...
          // properties again.
          var passiveKey = passive ? '_passive' : '';
    ...
    function getElementFromTouchHitTarget(targetFiber) {
      // Traverse through child fibers and find the first host components
      var node = targetFiber.child;
    ...
    function getChildHostContextForEvent(parentHostContext, type) {
      {
        var parentHostContextDev = parentHostContext;
    ...
    function createTextInstance(
    ...
    ) {
      {
        ...
        if (enableEventAPI) {
          var _eventData2 = hostContextDev.eventData;
          if (_eventData2 !== null) {
            !!_eventData2.isEventComponent
              ? warning$1(
                  false,
      ...
      while (
        ...
        (!enableSuspenseServerRenderer ||
          ...
          (node.data !== SUSPENSE_START_DATA &&
            node.data !== SUSPENSE_PENDING_START_DATA &&
            node.data !== SUSPENSE_FALLBACK_START_DATA))
      ) {
      ...
      while (
        ...
        (!enableSuspenseServerRenderer ||
          ...
          (next.data !== SUSPENSE_START_DATA &&
            next.data !== SUSPENSE_FALLBACK_START_DATA &&
            next.data !== SUSPENSE_PENDING_START_DATA))
      ) {
    ...
    function handleEventTarget(type, props, internalInstanceHandle) {
      // Touch target hit slop handling
      if (type === REACT_EVENT_TARGET_TOUCH_HIT) {
        // Validates that there is a single element
        var element = getElementFromTouchHitTarget(internalInstanceHandle);
        if (element !== null) {
          ...
          var lastElement = internalInstanceHandle.stateNode;
    ...
    function createFiberFromPortal(portal, mode, expirationTime) {
      // console.log('createFiberFromPortal');
    ...
    function ChildReconciler(shouldTrackSideEffects) {
      ...
      function updatePortal(returnFiber, current$$1, portal, expirationTime) {
        if (
          ...
          if(current$$1.stateNode.containerInfo !== portal.containerInfo){
            console.log('containerInfo changed');
            current$$1.stateNode.containerInfo = portal.containerInfo;
            current$$1.effectTag = (Placement | Deletion);
            console.log('current$$1', current$$1, current$$1.effectTag === (Placement | Deletion));
          }
          existing.return = returnFiber;
          return existing;
        }
      ...
      function reconcileSinglePortal(
        ...
        // console.log('reconcileSinglePortal');
        var key = portal.key;
        var child = currentFirstChild;
        while (child !== null) {
          // TODO: If key === null and child.key === null, then this only applies to
    ...
    function pushHostContextForEvent(fiber) {
      var context = requiredContext(contextStackCursor$1.current);
      var eventTypeof = fiber.type.$$typeof;
      var nextContext = getChildHostContextForEvent(context, eventTypeof);
      ...
      if (
        ...
        }
        {
          if (shouldWarnForUnbatchedSetState === true) {
            warnIfNotCurrentlyBatchingInDev$$1(fiber);
          }
        }
    ...
    function updateDehydratedSuspenseComponent(
      ...
      if (current$$1 === null) {
        ...
        if (isSuspenseInstanceFallback(suspenseInstance)) {
          ...
          workInProgress.expirationTime = computeAsyncExpiration(
            serverDisplayTime
          );
        } else {
      ...
      if (didReceiveUpdate || hasContextChanged$$1) {
        ...
        registerSuspenseInstanceRetry(
          suspenseInstance,
          retryTimedOutBoundary$$1.bind(null, current$$1)
        );
        return null;
      } else {
        // This is the first attempt.
      ...
      switch (workInProgress.tag) {
        ...
        case EventTarget: {
          if (enableEventAPI) {
            ...
            handleEventTarget(_type, newProps, workInProgress);
          }
          break;
        }
        default:
    ...
    function commitSuspenseComponent(finishedWork) {
      ...
      if (thenables !== null) {
        ...
        thenables.forEach(function (thenable) {
          ...
          var retry = resolveRetryThenable$$1.bind(
            null,
            finishedWork,
            thenable
          );
    ...
    function attachPingListener(root, renderExpirationTime, thenable) {
      ...
      if (!threadIDs.has(renderExpirationTime)) {
        ...
        var ping = pingSuspendedRoot$$1.bind(
          null,
          root,
          thenable,
          renderExpirationTime
    ...
    function commitAllHostEffects() {
      while (nextEffect !== null) {
        ...
        console.log('primaryEffectTag', primaryEffectTag, effectTag)
    ...
    function commitPassiveEffects(root, firstEffect) {
      ...
      if (rootExpirationTime !== NoWork) {
        requestWork$1(root, rootExpirationTime);
      }
    ...
    function warnIfNotCurrentlyBatchingInDev$1(fiber) {
      {
    ...
    function requestWork$1(root, expirationTime) {
    ...
    var requestCurrentTime$2 = notYetImplemented;
    var computeExpirationForFiber$2 = notYetImplemented;
    var captureCommitPhaseError$2 = notYetImplemented;
    var onUncaughtError$2 = notYetImplemented;
    var renderDidSuspend$2 = notYetImplemented;
    var renderDidError$2 = notYetImplemented;
    var pingSuspendedRoot$2 = notYetImplemented;
    var retryTimedOutBoundary$2 = notYetImplemented;
    var resolveRetryThenable$2 = notYetImplemented;
    var markLegacyErrorBoundaryAsFailed$2 = notYetImplemented;
    var isAlreadyFailedLegacyErrorBoundary$2 = notYetImplemented;
    var scheduleWork$2 = notYetImplemented;

    var flushRoot$2 = notYetImplemented;
    var batchedUpdates$3 = notYetImplemented;
    var unbatchedUpdates$2 = notYetImplemented;
    var flushSync$2 = notYetImplemented;
    var flushControlled$2 = notYetImplemented;

    var interactiveUpdates$3 = notYetImplemented;
    var flushInteractiveUpdates$3 = notYetImplemented;
    var computeUniqueAsyncExpiration$2 = notYetImplemented;
    var flushPassiveEffects$2 = notYetImplemented;
    var warnIfNotCurrentlyBatchingInDev$2 = notYetImplemented;
    ...
    var batchedUpdates$1 = batchedUpdates$2;
    var unbatchedUpdates$$1 = unbatchedUpdates$1;
    var flushSync$$1 = flushSync$1;
    var flushControlled$$1 = flushControlled$1;

    var interactiveUpdates$1 = interactiveUpdates$2;
    var flushInteractiveUpdates$1 = flushInteractiveUpdates$2;
    var computeUniqueAsyncExpiration$$1 = computeUniqueAsyncExpiration$1;
    var flushPassiveEffects$$1 = flushPassiveEffects$1;
    var warnIfNotCurrentlyBatchingInDev$$1 = warnIfNotCurrentlyBatchingInDev$1;

    if (enableNewScheduler) {
      requestCurrentTime$$1 = requestCurrentTime$2;
      computeExpirationForFiber$$1 = computeExpirationForFiber$2;
      captureCommitPhaseError$$1 = captureCommitPhaseError$2;
      onUncaughtError$$1 = onUncaughtError$2;
      renderDidSuspend$$1 = renderDidSuspend$2;
      renderDidError$$1 = renderDidError$2;
      pingSuspendedRoot$$1 = pingSuspendedRoot$2;
      retryTimedOutBoundary$$1 = retryTimedOutBoundary$2;
      resolveRetryThenable$$1 = resolveRetryThenable$2;
      markLegacyErrorBoundaryAsFailed$$1 = markLegacyErrorBoundaryAsFailed$2;
      isAlreadyFailedLegacyErrorBoundary$$1 = isAlreadyFailedLegacyErrorBoundary$2;
      scheduleWork$$1 = scheduleWork$2;
      flushRoot$$1 = flushRoot$2;
      batchedUpdates$1 = batchedUpdates$3;
      unbatchedUpdates$$1 = unbatchedUpdates$2;
      flushSync$$1 = flushSync$2;
      flushControlled$$1 = flushControlled$2;
      interactiveUpdates$1 = interactiveUpdates$3;
      flushInteractiveUpdates$1 = flushInteractiveUpdates$3;
      computeUniqueAsyncExpiration$$1 = computeUniqueAsyncExpiration$2;
      flushPassiveEffects$$1 = flushPassiveEffects$2;
      warnIfNotCurrentlyBatchingInDev$$1 = warnIfNotCurrentlyBatchingInDev$2;
    }
    ...
    function updateContainer(element, container, parentComponent, callback) {
      var current$$1 = container.current;
      var currentTime = requestCurrentTime$$1();
      var expirationTime = computeExpirationForFiber$$1(
        currentTime,
        current$$1
      );
    ...
    function createRoot(container, options) {
      ...
      (function () {
        if (!isValidContainer(container)) {
          {
            throw ReactError(
              functionName + '(...): Target container is not a DOM element.'
            );
          }
        }
      })();
